(() => {
  ...
  if (bookModal) {
    ...
    const SHOP_HOURS = {
      1: [9, 17],   // Mon 09:00–17:00
      2: [9, 17],   // Tue 09:00–17:00
      3: [9, 17],   // Wed 09:00–17:00
      4: [9, 17],   // Thu 09:00–17:00
      5: [9, 17],   // Fri 09:00–17:00
      6: [10, 16]   // Sat 10:00–16:00
      // Sun (0) closed
    };
    ...
    function buildIcsDataUri(start, end) {
      ...
      const uid = 'kouasfi-' + Math.random().toString(36).slice(2) + '@kapsalon-ouasfi.nl';
      const summary = `Kapsalon Ouasfi — ${state.serviceLabel}`;
      const description = `Afspraak: ${state.serviceLabel}\\nKapper: ${state.barberLabel}\\nNaam: ${state.name}\\n\\nWezenlaan 1, 6531 MJ Nijmegen`;

      const ics = [
        'BEGIN:VCALENDAR',
        'VERSION:2.0',
        'PRODID:-//Kapsalon Ouasfi//Booking//NL',
        'CALSCALE:GREGORIAN',
        'METHOD:PUBLISH',
        'BEGIN:VEVENT',
        `UID:${uid}`,
